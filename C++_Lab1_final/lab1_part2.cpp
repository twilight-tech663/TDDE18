...
// TODO: Complementary work: Only have one statement per line.
...
int main()
{
    float first_price{0}, last_price{0}, stride{0}, tax_percent{0};
    cout << left << "INPUT PART" << "\n"; 
    cout << "==========" << "\n";

    cout << left << "Enter first price: ";
    cin >> first_price;
    ...
    cout << left << "Enter last price:  ";  // or use setw() to fix the width
    cin >> last_price;
    ...
    cout << "-------------------------------------------------" << "\n";
    float price{0}, tax{0}, total_price{0};
